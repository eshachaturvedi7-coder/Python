#write a program to accept marks oStopAsyncIteration 6 students and display them in a sorted manner.
...
marks.append(s6)
print("Marks of students in sorted order: ", sorted(marks))